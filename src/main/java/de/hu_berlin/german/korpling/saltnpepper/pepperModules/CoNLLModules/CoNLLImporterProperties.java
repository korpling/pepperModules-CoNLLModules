...
public class CoNLLImporterProperties extends PepperModuleProperties 
{
	...
	public CoNLLImporterProperties()
	{
		...
		this.addProperty(new PepperModuleProperty<Boolean>(PROP_CONSIDER_PROJECTIVITY, Boolean.class, "States whether to create a salt pointing relation from projective head of tokens to the dependent.", true, false));
